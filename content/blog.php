<?php
$queryBlog = mysqli_query($koneksi, "SELECT categories.name, blog. * FROM blog JOIN categories ON categories.id = blog.id_category ORDER BY blog.id DESC");
                        ...
                        <div class="post-content d-flex flex-column">
                            ...
                            <div class="meta d-flex align-items-center">
                                <div class="d-flex align-items-center">
                                    <i class="bi bi-person"></i> <span class="ps-2"><?php echo $rowBlog['created_by'] ?></span>
                                </div>
