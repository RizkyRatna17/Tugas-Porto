...
$queryHome = mysqli_query($koneksi, "SELECT * FROM homes ORDER BY id DESC");
$rowHome = mysqli_fetch_all($queryHome, MYSQLI_ASSOC);
...
<head>
  ...
  <title><?php echo ($id) ? $rowEdit['title'] : '' ?></title>
