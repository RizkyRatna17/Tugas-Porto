...
if (isset($_POST['simpan'])) {
    ...
    if (!empty($_FILES['image']['name'])) {
        ...
        $update = "UPDATE portofolios SET title='$title', content='$content',is_active='$is_active', image='$image_name' , client_name='$client_name', project_date='$project_date', project_url='$project_url' ,id_category='$id_category' WHERE id='$id'";
    } else {
        $update = "UPDATE portofolios SET title='$title', content='$content',is_active='$is_active', client_name='$client_name', id_category='$id_category',project_date='$project_date', project_url='$project_url'  WHERE id='$id'";
    }
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="" name="project_date" class="form-control"
                                value="<?php echo ($id) ? $rowEdit['project_date'] : '' ?>">
                        </div>
                        <div class="mb-3">
                            <label for="" class="form-label">URL Project</label>
                            <input type="text" id="" name="project_url" class="form-control"
